...
public class PipeInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        radiusInputBox = new javax.swing.JTextField();
        ...
        jLabel11.setText("Radius (inches)");

        radiusInputBox.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        radiusInputBox.setToolTipText("Enter the radius of the pipe in inches (Outer Diameter)");
        radiusInputBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                radiusInputBoxActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                            ...
                                            .addComponent(radiusInputBox, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(clearBasketButton, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(221, 221, 221)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel11)
                            .addComponent(radiusInputBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(37, 37, 37)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel13)
    ...
    private void calcButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcButtonActionPerformed
        ...
        try {
            ...
            float newPipeRadius = Float.parseFloat(radiusInputBox.getText());
            ...
            // if len or Rad invalid give error message
            if (newPipeLen <= 6 && newPipeLen > 0 && newPipeRadius > 0) {
                ...
                if ((selItem < 4) && (selItem > 0)) {
                    if (pipeColDropDown.getSelectedItem() == "No Colour") {
                        ...
                        if ((innerInsuCheckBox.isSelected() == false) && (ReinforcementInputBox.isSelected() == false)) {
                            ...
                            PipeI newPipe = new PipeI(newPipePlastic, (double) newPipeLen, (double) newPipeRadius, pipeRes);
                            ...
                            + "m |  Radius: " + roundAndString(newPipe.getOuterRadius()) + "in |  Grade: " +
                ...
                if ((selItem > 1) && (selItem < 5)) {
                    if (pipeColDropDown.getSelectedItem() == "1") {
                        if ((innerInsuCheckBox.isSelected() == false) && (ReinforcementInputBox.isSelected() == false)) {
                            PipeII newPipe = new PipeII(newPipePlastic, (double) newPipeLen, (double) newPipeRadius, pipeRes);
                            pipeCostArea.setText("£" + roundAndString(newPipe.calculateCost()));
                            //adds the correct quantity of pipes to the basket
                            for(int i=0; i<(Integer)QuantityBox.getValue(); i++) {
                                pipeBasket.add(newPipe);
                ...
                if ((selItem > 1) && (selItem < 6) && pipeRein == false ) {
                    if (pipeColDropDown.getSelectedItem() == "2"){
                        if ((innerInsuCheckBox.isSelected() == false) && (ReinforcementInputBox.isSelected() == false)) {
                            //pipe type 3
                            PipeIII newPipe = new PipeIII(newPipePlastic, (double) newPipeLen, (double) newPipeRadius, pipeRes);
                            pipeCostArea.setText("£" + roundAndString(newPipe.calculateCost()));
                            //adds the correct quantity of pipes to the basket
                            for(int i=0; i<(Integer)QuantityBox.getValue(); i++) {
                                pipeBasket.add(newPipe);
                            ...
                            //pipe type 4
                            PipeIV newPipe = new PipeIV(newPipePlastic, (double) newPipeLen, (double) newPipeRadius, pipeRes, pipeInsu);
                            pipeCostArea.setText("£" + roundAndString(newPipe.calculateCost()));
                            //adds the correct quantity of pipes to the basket
                            for(int i=0; i<(Integer)QuantityBox.getValue(); i++) {
                                pipeBasket.add(newPipe);
                ...
                if ((selItem > 2) && (selItem < 6)) {
                    if (pipeColDropDown.getSelectedItem() == "2") {
                        if ((innerInsuCheckBox.isSelected() == true) && (ReinforcementInputBox.isSelected() == true)) {
                            ...
                            PipeV newPipe = new PipeV(newPipePlastic, (double) newPipeLen, (double) newPipeRadius, pipeRes, pipeInsu, pipeRein);
                            pipeCostArea.setText("£" + roundAndString(newPipe.calculateCost()));
                            //adds the correct quantity of pipes to the basket
                            for(int i=0; i<(Integer)QuantityBox.getValue(); i++) {
                                pipeBasket.add(newPipe);
            ...
            else if(newPipeRadius <= 0){
                JOptionPane.showMessageDialog(new JFrame(), "Invalid Pipe: Pipe cannot have radius less than or equal to 0 ");
            }
            else{
    ...
    private void radiusInputBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radiusInputBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_radiusInputBoxActionPerformed
    ...
    private javax.swing.JTextField radiusInputBox;
